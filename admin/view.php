<?php
    ...
    if(!empty($_GET['id'])){ #si la Super Global get avec ID n'est pas vide.
        $id = checkInput($_GET['id']); #tu vas le mettre dans une variable
    }
    ...
    $item = $statement->fetch(); #stocker dans la variable item
    Database::disconnect();
